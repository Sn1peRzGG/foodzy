	...
	return (
		<div className='relative w-full h-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-md flex flex-col group'>
			<button
				...
				className='absolute top-0 right-0 w-16 h-14 lg:w-20 lg:h-18 bg-accent hover:bg-accent-hover/90 text-white flex items-center justify-center cursor-pointer z-20 rounded-tr-[21px] rounded-bl-[42.5px] shadow-sm active:scale-95 transition-transform duration-150'
			>
				<Heart
			...
			<Link
				...
				className='flex flex-col justify-between rounded-[21px] shadow-md dark:shadow-black/40(0,0,0,0.08)] bg-card-bg overflow-hidden cursor-pointer h-full w-full'
			>
				<div className='flex flex-col flex-1 justify-start pt-5 sm:pt-6 md:pt-8 lg:pt-9 px-4 sm:px-5 md:px-6 lg:px-12 pb-5 sm:pb-6 md:pb-8 lg:pb-10'>
					...
					<p className='text-text-muted font-semibold text-xs sm:text-sm md:text-base lg:text-[20px] leading-[1.4] mt-3'>
						{product.description}
					</p>
				</div>
			</Link>
